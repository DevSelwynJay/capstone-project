...
$ctr = 0;$cc=1;
while ($cc<8){
    $results1[$ctr] = mysqli_query($con, "SELECT event_id FROM vaccination_record WHERE patient_purok='$cc' AND patient_type='Infant' AND vaccine_name='BCG' group by patient_id");
...
<div class="tab">
    <div id="wk3" class="timestamp">Weekly</div>
    <div id="mo3" class="timestamp" >Monthly</div>
    <div id="yr3" class="timestamp" >Yearly</div>
    <div id="ov3" class="timestamp" >Overall</div>
</div>
...
<script>
    ...
    var speedData = {
        ...
        datasets: [bcginfant,bcgminor,bcgadult,bcgsenior,bcgpwd,bcgpregnant]
    };
    ...
    var bcglineChart = new Chart(speedCanvas, {
        type: 'line',
        data: speedData,
