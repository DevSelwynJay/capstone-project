...
$ctr = 0;$cc=1;
while ($cc<8){
    $results1[$ctr] = mysqli_query($con, "SELECT event_id FROM vaccination_record WHERE patient_purok='$cc' AND patient_type='Infant' AND vaccine_name='IPV' group by patient_id");
...
$temp = '';
while ($cc<8){
    $results[$ctr] = mysqli_query($con, "SELECT vaccine_id FROM vaccination_record WHERE patient_purok='$cc' AND patient_type='Minor' AND vaccine_name='IPV' group by patient_id");
...
<div class="tab">
    <div id="wk2" class="timestamp">Weekly</div>
    <div id="mo2" class="timestamp" >Monthly</div>
    <div id="yr2" class="timestamp" >Yearly</div>
    <div id="ov2" class="timestamp" >Overall</div>
</div>
...
<script>
    ...
    var ipvlineChart = new Chart(speedCanvas, {
        type: 'line',
        data: speedData,
