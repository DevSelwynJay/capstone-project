...
$ctr = 0;$cc=1;
while ($cc<8){
    $results1[$ctr] = mysqli_query($con, "SELECT event_id FROM vaccination_record WHERE patient_purok='$cc' AND patient_type='Infant' AND vaccine_name='MMR' ");
...
$temp = '';
while ($cc<8){
    $results[$ctr] = mysqli_query($con, "SELECT vaccine_id FROM vaccination_record WHERE patient_purok='$cc' AND patient_type='Minor' AND vaccine_name='MMR'");
