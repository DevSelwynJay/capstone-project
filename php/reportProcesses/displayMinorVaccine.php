...
$patientqry = "Select * from `vaccination_record` where `patient_type` = 'Minor' and `date_given` > NOW()-interval ".$time." limit $start_from,$rpp ";
...
if(mysqli_num_rows($result)>0){
    ...
    $page_qry = "Select * from `vaccination_record` where `patient_type` = 'Minor' and `date_given` > NOW()-interval ".$time." order by `date_given` asc";
