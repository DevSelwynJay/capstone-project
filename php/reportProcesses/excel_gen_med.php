...
// Column names
$fields = array('PATIENT NAME', 'BIRTHDATE', 'ADDRESS', 'GENDER', 'VACCINE GIVEN','ADMINISTERED BY','DATE GIVEN' );
    ...
    while($row = mysqli_fetch_assoc($res)) {
        ...
        while ($row2 = mysqli_fetch_assoc($adminrecord)) {
            ...
            while ($row3 = mysqli_fetch_assoc($record2)) {
                ...
                $gender = $row3['gender'];
                $lineData = array($pat_name, $bday, $comaddress, $gender, $vaccine_name, $admin_name, $date_given);
