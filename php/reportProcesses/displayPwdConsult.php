...
$patientqry = "Select * from `medication_record` where `patient_type` = 'PWD' and `date_given` > NOW()-interval ".$time." limit $start_from,$rpp";
...
if(mysqli_num_rows($result)>0){
    ...
    $page_qry = "Select * from `medication_record` where `patient_type` = 'PWD' and `date_given` > NOW()-interval ".$time." ";
